...
{
    public partial class drm_2_beat : Form
    {
        public drm_2_beat()
        {
            InitializeComponent();
        ...
        //soundplayer object
        SoundPlayer two_beat = new SoundPlayer(@"2 beat 85 bpm 10 bar.wav");

        private void btn_2_beat_play_Click(object sender, EventArgs e)
        {
        ...
        private void btn_2_beat_stop_Click(object sender, EventArgs e)
        {
            two_beat.Stop();
            clear_beats();
